...
import menu_open from '../../assets/menu_open2.png'   /* resposive */
  ...
  return (
    <div className='navbar'>
      ...
      <ul ref={menuRef} className="nav-menu">
        ...
        <li><AnchorLink className='anchor-link' offset={50} href='#exp'><p onClick={()=>setMenu("exp")}>Experience</p></AnchorLink>{menu=="exp"?<img src={underline} alt='' className='underline'/>:<></>}</li>
